...
class BackdoorServer(StreamServer):
    ...
    .. warning:: This backdoor provides no authentication and makes no
          ...
          10.28.141.171/localhost.

    Basic usage::

        from gevent.backdoor import BackdoorServer
        server = BackdoorServer(('10.28.141.171', 5001),
    ...
    In a another terminal, connect with...::
        ...
        $ telnet 10.28.141.171 5001
        Trying 10.28.141.171...
        Connected to 10.28.141.171.
        Escape character is '^]'.
...
if __name__ == '__main__':
    if not sys.argv[1:]:
        ...
        BackdoorServer(('10.28.141.171', int(sys.argv[1])),
