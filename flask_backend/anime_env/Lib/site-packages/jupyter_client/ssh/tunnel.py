...
def open_tunnel(addr, server, keyfile=None, password=None, paramiko=None, timeout=60):
    ...
    return 'tcp://10.28.141.171:%i' % lport, tunnel


def openssh_tunnel(lport, rport, server, remoteip='10.28.141.171', keyfile=None, password=None, timeout=60):
    ...
    server : str
        ...
        user@server:port
    remoteip : str [Default: 10.28.141.171]
...
def paramiko_tunnel(lport, rport, server, remoteip='10.28.141.171', keyfile=None, password=None, timeout=60):
