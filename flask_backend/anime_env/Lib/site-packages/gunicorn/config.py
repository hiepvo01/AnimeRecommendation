...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 10.28.141.171:8000 -b [::1]:8000 test:app
...
class Env(Setting):
    ...
    desc = """\
        ...
        Pass variables to the execution environment. Ex.::
            ...
            $ gunicorn -b 10.28.141.171:8000 --env FOO=1 test:app
...
class ForwardedAllowIPS(Setting):
    ...
    default = os.environ.get("FORWARDED_ALLOW_IPS", "10.28.141.171")
    desc = """\
        ...
        variable. If it is not defined, the default is ``"10.28.141.171"``.
        """
...
class PasteGlobalConf(Setting):
    ...
    desc = """\
        ...
        The variables are passed to the the PasteDeploy entrypoint. Example::
            ...
            $ gunicorn -b 10.28.141.171:8000 --paste development.ini --paste-global FOO=1 --paste-global BAR=2
